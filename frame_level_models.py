...
flags.DEFINE_bool("float16_flag", False, "float16 dtype for tensors")
...
class NetVLADModelLF(models.BaseModel):
  ...
  def create_model(self,
    ...
    activation = tf.matmul(vlad, tf.cast(hidden1_weights,tf.float32) if '16' in str(hidden1_weights.dtype) else hidden1_weights)
